...
mdc_TabBar.prototype = $extend(coconut_ui_View.prototype,{
	...
	,afterInit: function(elem) {
		var _gthis = this;
		haxe_Log.trace("afterInit",{ fileName : "TabBar.hx", lineNumber : 53, className : "mdc.TabBar", methodName : "afterInit"});
