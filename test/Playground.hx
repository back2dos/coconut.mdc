...
<div class="demo">
    ...
    <div>
        ...
        <TextField caption="Boxed input" box />
        <TextField caption="Icon input" box icon="list" />
        <TextField caption="TextArea" textArea  />
        <br/>
        <TextField caption="Text input fullWidth" fullWidth />
        <TextField caption="TextArea fullWidth" textArea fullWidth />
    </div>
